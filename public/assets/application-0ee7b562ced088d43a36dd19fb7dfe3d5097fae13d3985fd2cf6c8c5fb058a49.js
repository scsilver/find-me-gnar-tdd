...
(function() {
  var access_parameters, access_token, calculateAndDisplayRoute, form, grabImages, initMap, onDataLoaded;
  ...
  grabImages = function(tag, count, access_parameters) {
    var instagramUrl, lat, latlog, loc, log;
    loc = this.resort.location;
    lat = loc.split(',')[0];
    log = loc.split(',')[1];
    latlog = 'lat=' + lat + '&lng=' + log;
    instagramUrl = 'https://api.instagram.com/v1/media/search?' + latlog + '&distance=10000&callback=?&count=' + count;
    $.getJSON(instagramUrl, access_parameters, onDataLoaded);
  };

  onDataLoaded = function(instagram_data) {
    var error, instagram, key, photo, photos;
    instagram = $('#instagram');
  ...
  initMap = function() {
    var directionsDisplay, directionsService, map, onChangeHandler;
  ...
  calculateAndDisplayRoute = function(directionsService, directionsDisplay) {
    ...
    directionsService.route({
      ...
      destination: this.resort.location,
